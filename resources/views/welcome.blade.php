    ...
    <script>
        ...
        function getWeather() {
            ...
            if (storedData) {
                ...
                displayWeather(data, data.forecast.forecastday.slice(0, displayedDays));
                totalDays = data.forecast.forecastday.length;
                ...
                fetch(`/weather?city=${city}&days=${displayedDays + 12}`)
